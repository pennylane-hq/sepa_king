...
RSpec.describe SEPA::DirectDebit do
  ...
  describe :to_xml do
    context 'with invalid creditor' do
      it 'fails' do
        expect do
    ...
    context 'when setting debtor address with adrline' do
      subject do
    ...
    context 'when setting debtor address with structured fields' do
      subject do
        sdd = SEPA::DirectDebit.new name: 'Gläubiger GmbH',
                                    iban: 'DE87200500001234567890',
                                    creditor_identifier: 'DE98ZZZ09999999999'
    ...
    context 'with valid creditor' do
      ...
      context 'with large message identification' do
        ...
        it 'fails as the payment identification becomes too large' do
