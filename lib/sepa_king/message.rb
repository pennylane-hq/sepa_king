...
module SEPA
  ...
  class Message
    ...
    def schema_compatible?(schema_name)
      raise ArgumentError.new("Schema #{schema_name} is unknown!") unless known_schemas.include?(schema_name)

      case schema_name
      when PAIN_001_002_03, PAIN_008_002_02
        account.bic.present? && transactions.all? { |t| t.schema_compatible?(schema_name) }
      when PAIN_001_001_03, PAIN_001_001_09, PAIN_001_001_03_CH_02, PAIN_001_003_03, PAIN_008_003_02, PAIN_008_001_02
    ...
    def build_group_header(builder)
      builder.GrpHdr do
        ...
        builder.CtrlSum(format('%.2f', amount_total))
        builder.InitgPty do
